...
- la datatable WhiteCompany dei rifornimenti espone oggi solo mezzo, operatore, data e km: i record senza `liters/total_cost/station_name` vengono marcati come non importabili e contati come `skipped`, senza inventare dati mancanti
