...
- Il frontend raggruppa i risultati nell'ordine operativo `Utenze`, `Ruolo`, `Catasto`: una ricerca per nome, cognome o codice fiscale mostra quindi prima l'utenza e solo dopo avvisi di pagamento e risultati catastali. Il ranking interno di ciascun gruppo resta quello restituito dall'API.
