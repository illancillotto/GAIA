...
import PresenzeAnomaliePage from "@/app/presenze/anomalie/page";
import { currentMonthValue, monthLabel, previousMonthValue } from "@/lib/presenze-anomaly-months";
...
describe("Presenze anomalie page", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    ...
    mocks.getPresenzeDailyRecord.mockImplementation(async (_token: string, recordId: string) => {
