...
import PresenzeBankHoursPage from "@/app/presenze/banca-ore/page";

const mocks = vi.hoisted(() => ({
  getStoredAccessToken: vi.fn(),
  getPresenzeBankHoursDashboard: vi.fn(),
  getPresenzeBankHoursCollaboratorDetail: vi.fn(),
  createPresenzeBankHoursAdjustment: vi.fn(),
  updatePresenzeBankHoursAdjustment: vi.fn(),
  reviewPresenzeBankHoursAdjustment: vi.fn(),
  deletePresenzeBankHoursAdjustment: vi.fn(),
}));
...
vi.mock("@/lib/api", () => ({
  getPresenzeBankHoursDashboard: mocks.getPresenzeBankHoursDashboard,
  getPresenzeBankHoursCollaboratorDetail: mocks.getPresenzeBankHoursCollaboratorDetail,
  createPresenzeBankHoursAdjustment: mocks.createPresenzeBankHoursAdjustment,
  updatePresenzeBankHoursAdjustment: mocks.updatePresenzeBankHoursAdjustment,
  reviewPresenzeBankHoursAdjustment: mocks.reviewPresenzeBankHoursAdjustment,
  deletePresenzeBankHoursAdjustment: mocks.deletePresenzeBankHoursAdjustment,
}));
...
describe("Presenze banca ore page", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mocks.getStoredAccessToken.mockReturnValue("token");
    mocks.getPresenzeBankHoursDashboard.mockResolvedValue({
    ...
    mocks.getPresenzeBankHoursCollaboratorDetail.mockResolvedValue({
      collaborator: {
        id: "collab-1",
        owner_user_id: 1,
        application_user_id: null,
    ...
    mocks.createPresenzeBankHoursAdjustment.mockResolvedValue({
      id: "adj-1",
      collaborator_id: "collab-1",
  ...
  test("renders dashboard and creates a pending liquidation from guidance", async () => {
    ...
    await waitFor(() => {
      expect(mocks.createPresenzeBankHoursAdjustment).toHaveBeenCalledWith(
        "token",
