...
export default function PresenzeCollaboratoreDetailPage() {
  ...
  return (
    <ProtectedPage title="Dettaglio collaboratore" description="Calendario giornaliero e riepilogo eventi." breadcrumb="Giornaliere" requiredModule="presenze">
            ...
            {canEdit ? (
              <article className="panel-card">
                <div className="mb-4">
                  ...
                  <p className="section-copy">Seleziona l&apos;utente GAIA da collegare a questo collaboratore delle giornaliere.</p>
                </div>
