    ...
    <article className="overflow-hidden rounded-[28px] border border-[#d9dfd6] bg-white shadow-panel">
      ...
      <div className="p-6">
        ...
        <div className="mt-4 grid gap-3 text-sm text-gray-600 md:grid-cols-4">
          <div>
            Completate: <span className="font-medium text-emerald-700">{batch.completed_items}</span>
          </div>
          <div>
            Fallite: <span className="font-medium text-red-700">{batch.failed_items}</span>
          </div>
          <div>
            Saltate: <span className="font-medium text-slate-700">{batch.skipped_items}</span>
          </div>
          <div>
            Stato batch: <span className="font-medium text-gray-900">{batch.status}</span>
          </div>
        </div>
      </div>
    </article>
