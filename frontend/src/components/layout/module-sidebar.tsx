...
export function ModuleSidebar({
  ...
  if (currentModuleKey === "ruolo") {
    return (
      <div className="space-y-0.5 px-2 pb-3">
        ...
        <NavItem href="/ruolo/tributi" icon={LockIcon} label="Tributi" match="prefix" inactiveWhenHash="#raccomandate-poste" />
        <NavItem href="/ruolo/tributi#raccomandate-poste" icon={DocumentIcon} label="Raccomandate" />
  ...
  if (currentModuleKey === "presenze") {
    return (
      <div className="space-y-0.5 px-2 pb-3">
        <p className="px-2 pb-1 pt-4 text-[10px] font-medium uppercase tracking-widest text-gray-400">Panoramica</p>
        <NavItem href="/presenze" icon={GridIcon} label="Dashboard" />
        ...
        <NavItem href="/presenze/configurazione" icon={LockIcon} label="Configurazione" match="prefix" />
        <NavItem href="/presenze/settings" icon={DocumentIcon} label="Settings" match="prefix" />
      </div>
    );
  }
