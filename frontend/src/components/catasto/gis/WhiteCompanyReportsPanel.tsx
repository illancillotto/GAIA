  ...
  const items = [
    {
      label: "totali",
      value: stats?.total ?? 0,
      className: isDark ? "bg-white/10 text-white" : "bg-white/80 text-slate-800",
      labelClass: isDark ? "text-white/45" : "text-slate-400",
    },
    {
      label: "in mappa",
      value: stats?.mapped ?? 0,
      className: isDark ? "bg-rose-500/20 text-rose-50" : "bg-rose-50 text-rose-700",
      labelClass: isDark ? "text-rose-50/60" : "text-rose-900/45",
    },
    {
      label: "senza GPS",
      value: stats?.unmapped ?? 0,
      className: isDark ? "bg-amber-500/20 text-amber-50" : "bg-amber-50 text-amber-700",
      labelClass: isDark ? "text-amber-50/60" : "text-amber-900/45",
    },
  ];
