...
const EXPORT_FIELD_DEFS_UTENZE: ExportFieldDef[] = [
  ...
  { key: "capacitas_rpt_certificato_url", label: "Link Capacitas (rptCertificato)" },
  { key: "utenza_comune_id", label: "Comune ID" },
  { key: "utenza_cod_provincia", label: "Cod provincia" },
  { key: "utenza_cod_comune_capacitas", label: "Cod comune Capacitas" },
  { key: "utenza_cod_frazione", label: "Cod frazione" },
  { key: "utenza_num_distretto", label: "Num distretto" },
  { key: "utenza_nome_distretto_loc", label: "Nome distretto" },
  { key: "utenza_nome_comune", label: "Nome comune" },
  { key: "utenza_sezione_catastale", label: "Sezione catastale" },
  { key: "utenza_foglio", label: "Foglio" },
  { key: "utenza_particella", label: "Particella" },
  { key: "utenza_subalterno", label: "Subalterno" },
  { key: "utenza_particella_id", label: "Particella ID" },
  { key: "utenza_sup_catastale_mq", label: "Sup catastale (mq)" },
