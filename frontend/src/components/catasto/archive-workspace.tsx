...
import type { CatastoBatch, CatastoComune, CatastoDocument } from "@/types/api";
...
export function CatastoArchiveWorkspace({ initialView }: { initialView: ArchiveView }) {
  ...
  return (
    <ProtectedPage
      title="Archivio"
      description="Consultazione unificata di batch e documenti del modulo Catasto."
      breadcrumb="Catasto / Archivio"
    >
      <CatastoHero
        badge={
          <>
        ...
        title="Un unico archivio per seguire la filiera Catasto: dai lotti eseguiti ai documenti prodotti."
        description="Le due viste restano distinte perché rappresentano entità diverse, ma la consultazione è concentrata in una sola pagina, con navigazione più lineare."
        actions={
          sharedError ? (
      ...
      <article className="overflow-hidden rounded-[28px] border border-[#d9dfd6] bg-white shadow-panel">
        ...
        <div className="grid gap-4 p-6 md:grid-cols-2">
          ...
          <Link
            ...
            href="/catasto/archive?view=batches"
          >
            <div className="flex items-center gap-3">
