...
class SisterSelectorsConfig:
    ...
    convention_id: str = "1050380"
    convention_label: str = "CONSORZIO DI BONIFICA DELL'ORISTANESE (CONSULTAZIONI - PROFILO A)"
    convention_radio_selector: str = "form[name='SelConv'] input[name='idConv'][type='radio']"
    convention_submit_selector: str = "form[name='SelConv'] input[type='submit'][value='Avanti']"
