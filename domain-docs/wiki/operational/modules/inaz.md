...
Il modulo Inaz supporta consultazione collaboratori, giornate lavorative, organigramma, export HR e gestione operativa di recuperi e banca ore.

## Cosa puo fare l'operatore

- leggere scheda collaboratore e responsabilita
- orientarsi nell'organigramma Inaz
- interpretare dati giornalieri e anomalie
- trovare responsabili e operatori collegati
- verificare saldo banca ore, snapshot Inaz e rettifiche manuali
...
- `/inaz/collaboratori`: schede collaboratore
- `/inaz/organigramma`: albero organizzativo Inaz
- `/inaz/banca-ore`: saldo ore, guida liquidazione e workflow HR
- `/inaz/recuperi`: recuperi maturati e fruiti
- `/inaz/export`: export XLSM mensile
- `/inaz/configurazione`: template orari e policy amministrative del modulo
...
- La policy banca ore puo essere aggiornata dagli admin in `/inaz/configurazione`.

## Prossimi passi

Indica collaboratore, periodo o pagina Inaz e ti guido nella consultazione o nella verifica operativa.
