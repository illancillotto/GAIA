# Pagina Banca Ore Inaz

## Scopo

La pagina `/inaz/banca-ore` aiuta HR a controllare il saldo banca ore importato da Inaz, applicare rettifiche manuali e usare una proposta di liquidazione guidata.

## Cosa puo fare l'operatore

- leggere saldo importato, saldo effettivo e liquidato
- aprire il dettaglio di un collaboratore
- verificare snapshot mensili Inaz e workflow rettifiche
...
- la policy che governa questi passaggi si configura da `/inaz/configurazione`
