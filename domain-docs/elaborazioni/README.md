...
- la pagina completa `/elaborazioni/settings` nel tab SISTER usa pool e form a tutta larghezza: il riepilogo laterale `Dettagli SISTER` e il box `Flusso consigliato` sono stati rimossi perche duplicavano stato gia visibile nel pool, nell'header e nel form
...
- ogni card SISTER puo attivare `Usa solo fuori dall'orario dell'operatore` e configurare una o piu fasce per giorno; il preset propone lunedi-venerdi `15:00-07:30`, sabato-domenica tutto il giorno e il primo sabato del mese dalle `14:00`, con stato corrente e prossima disponibilita leggibili direttamente nella card
