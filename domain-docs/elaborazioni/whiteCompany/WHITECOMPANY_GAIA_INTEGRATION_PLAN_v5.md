# WhiteCompany → GAIA — Piano di integrazione organico v5

> Stato: v5 — 10 aprile 2026
...
28. Endpoint `/api/utenze/bonifica-staging` + UI revisione
29. Bulk approve per `review_status=new`
30. Singola approve/reject per `review_status=mismatch`

### Fase 6 — Magazzino e organigrammi
31. Migration `add_warehouse_request`
32. Migration `add_wc_org_charts`
33. `backend/app/modules/elaborazioni/bonifica_oristanese/apps/warehouse_requests/client.py`
34. `backend/app/modules/inventory/services/sync_warehouse.py`
35. `backend/app/modules/elaborazioni/bonifica_oristanese/apps/org_charts/client.py`
36. `backend/app/modules/accessi/services/sync_org_charts.py`
...
41. UI revisione consorziati `/api/utenze/bonifica-staging`
