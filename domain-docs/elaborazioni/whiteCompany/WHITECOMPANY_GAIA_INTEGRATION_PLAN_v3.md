# WhiteCompany → GAIA — Piano di integrazione organico v3

> Stato: v3 — 10 aprile 2026
...
### Fase 4 — Operatori
23. `backend/app/modules/elaborazioni/bonifica_oristanese/apps/users/client.py` — fetch ruoli operativi (escluso Consorziato)
24. `backend/app/modules/operazioni/services/sync_operators.py` — upsert `wc_operator`
