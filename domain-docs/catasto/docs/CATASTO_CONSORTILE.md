...
- autosync notturno a chunk con checkpoint persistente per CF/PIVA, anno letto
  esclusivamente da Capacitas e precedenza ai job manuali; gli anni invalidi
  sono scartati e tracciati nel risultato del job
