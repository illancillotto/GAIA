...
- I popover dei controlli layer `Distretti` e `Particelle` devono restare utilizzabili mentre l'operatore sposta il cursore verso slider e toggle di riempimento/opacita, evitando chiusure accidentali tra pill e pannello.
