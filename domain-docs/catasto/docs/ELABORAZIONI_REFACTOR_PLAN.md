...
- `backend/app/modules/catasto/capacitas/`
- `backend/app/modules/catasto/capacitas_routes.py`
- `backend/app/services/catasto_documents.py`
- `frontend/src/app/catasto/documents/`
- `frontend/src/app/catasto/capacitas/`
...
- credenziali Capacitas: se appartengono al provider di dominio, restano sotto `catasto`
