...
from sqlalchemy import Boolean, Date, DateTime, ForeignKey, Index, Integer, String, Text, Uuid, desc, func
...
class AnprSyncConfig(Base):
    ...
    job_cron: Mapped[str] = mapped_column(String(50), default="0 2 * * *", nullable=False)
