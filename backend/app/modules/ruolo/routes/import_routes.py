...
async def upload_ruolo(
    file: UploadFile,
    anno_tributario: Annotated[int, Form()],
    ...
    existing_count = check_anno_already_imported(db, anno_tributario)
    ...
    task = asyncio.create_task(
        run_import_job(job_id, raw_content, anno_tributario, filename=filename)
    )
