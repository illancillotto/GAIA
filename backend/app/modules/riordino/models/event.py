...
class RiordinoEvent(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_riordino_events_block_created", "block_id", "created_at"),
    ...
    block_id: Mapped[uuid.UUID | None] = mapped_column(
        ForeignKey("riordino_blocks.id", ondelete="CASCADE"), nullable=True
    )
    ...
    practice: Mapped["RiordinoPractice | None"] = relationship("RiordinoPractice", back_populates="events")
    block: Mapped["RiordinoBlock | None"] = relationship("RiordinoBlock", back_populates="events")
