...
from app.modules.organigramma.schemas import StructureKindLiteral, VisibilityResult
...
def get_visibility(
    ...
    return svc.build_visibility_result(db, viewer, structure_kind=structure_kind)
