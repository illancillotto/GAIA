...
from app.models.catasto_phase1 import CatDistretto, CatParticella
...
def _resolve_anno_riferimento(db: Session, anno: int | None) -> int | None:
    if anno is not None:
        return anno
...
def get_indici_overview(
    ...
    anno_riferimento = _resolve_anno_riferimento(db, anno)
    distretti = list(
