...
DEFAULT_SECTIONS = [
    ...
    ("inaz.dashboard", "Giornaliere - Dashboard", "inaz", "viewer"),
    ("inaz.giornaliere", "Giornaliere - Giornaliere", "inaz", "viewer"),
    ("inaz.import", "Giornaliere - Import", "inaz", "admin"),
    ("inaz.sync", "Giornaliere - Sync portale", "inaz", "admin"),
    ("inaz.review", "Giornaliere - Review", "inaz", "reviewer"),
    ("inaz.export", "Giornaliere - Export", "inaz", "reviewer"),
    ("inaz.admin", "Giornaliere - Amministrazione", "inaz", "admin"),
