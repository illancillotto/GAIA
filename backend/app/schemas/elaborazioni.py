from app.schemas.catasto import (
    ...
    CatastoRuoloAutoSyncConfigResponse as ElaborazioneRuoloAutoSyncConfigResponse,
    CatastoRuoloAutoSyncConfigUpdateRequest as ElaborazioneRuoloAutoSyncConfigUpdateRequest,
    CatastoRuoloAutoSyncItemResponse as ElaborazioneRuoloAutoSyncItemResponse,
    CatastoRuoloAutoSyncStatusCountsResponse as ElaborazioneRuoloAutoSyncStatusCountsResponse,
    CatastoRuoloAutoSyncStatusResponse as ElaborazioneRuoloAutoSyncStatusResponse,
...
__all__ = [
    ...
    "ElaborazioneRuoloAutoSyncStatusCountsResponse",
