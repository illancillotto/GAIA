...
class CapacitasAnagraficaHistoryImportJob(Base):
    __tablename__ = "capacitas_anagrafica_history_import_jobs"
    ...
    status: Mapped[str] = mapped_column(String(32), default="pending", nullable=False, index=True)
    mode: Mapped[str] = mapped_column(String(32), default="history_import", nullable=False)
    payload_json: Mapped[dict | list | None] = mapped_column(JSON, nullable=True)
    result_json: Mapped[dict | list | None] = mapped_column(JSON, nullable=True)
    error_detail: Mapped[str | None] = mapped_column(Text, nullable=True)
    started_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
...
class CapacitasDomandeIrrigueSyncJob(Base):
    __tablename__ = "capacitas_domande_irrigue_sync_jobs"
    ...
    status: Mapped[str] = mapped_column(String(32), default="pending", nullable=False, index=True)
    mode: Mapped[str] = mapped_column(String(32), default="anagrafica_search", nullable=False)
    payload_json: Mapped[dict | list | None] = mapped_column(JSON, nullable=True)
    result_json: Mapped[dict | list | None] = mapped_column(JSON, nullable=True)
    error_detail: Mapped[str | None] = mapped_column(Text, nullable=True)
    started_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
...
class CapacitasDomandeIrrigueAutoSyncState(Base):
    __tablename__ = "capacitas_domande_irrigue_autosync_state"

    id: Mapped[int] = mapped_column(Integer, primary_key=True, default=1)
    cursor: Mapped[str | None] = mapped_column(String(32), nullable=True)
    pending_cursor: Mapped[str | None] = mapped_column(String(32), nullable=True)
    pending_job_id: Mapped[int | None] = mapped_column(
        ForeignKey("capacitas_domande_irrigue_sync_jobs.id", ondelete="SET NULL"),
        nullable=True,
    )
    cycle_key: Mapped[str | None] = mapped_column(String(32), nullable=True)
    completed_cycle_key: Mapped[str | None] = mapped_column(String(32), nullable=True)
    processed_identifiers: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
...
class CapacitasInCassSyncJob(Base):
    __tablename__ = "capacitas_incass_sync_jobs"
    ...
    status: Mapped[str] = mapped_column(String(32), default="pending", nullable=False, index=True)
    mode: Mapped[str] = mapped_column(String(32), default="subjects_sync", nullable=False)
    payload_json: Mapped[dict | list | None] = mapped_column(JSON, nullable=True)
    result_json: Mapped[dict | list | None] = mapped_column(JSON, nullable=True)
    error_detail: Mapped[str | None] = mapped_column(Text, nullable=True)
    started_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
