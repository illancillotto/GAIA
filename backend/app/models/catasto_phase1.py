...
class CatAdeSyncRun(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(Uuid, primary_key=True, default=uuid.uuid4)
    status: Mapped[str] = mapped_column(String(20), default="processing", nullable=False, index=True)
    progress_phase: Mapped[str] = mapped_column(String(20), default="queued", nullable=False)
    ...
    tiles_completed: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
...
class CatMeterReading(Base):
    ...
    record_kind: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    operational_state: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
