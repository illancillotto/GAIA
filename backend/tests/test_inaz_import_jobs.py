...
from app.modules.inaz.models import InazImportJob
from app.modules.inaz.services import import_jobs
from app.modules.inaz.services.parser import ParsedCollaboratorPayload, ParsedImportPayload
...
def test_run_import_job_marks_job_failed_when_collaborator_import_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    try:
        ...
        job = db.execute(select(InazImportJob).order_by(InazImportJob.created_at.desc())).scalar_one()
