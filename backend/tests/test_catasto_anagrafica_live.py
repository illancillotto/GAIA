...
CapacitasLiveAuthoritativeSanitizer = importlib.import_module(
    "app.modules.catasto.routes.anagrafica.normalization"
).CapacitasLiveAuthoritativeSanitizer


def _build_match(
    *, cert_com: str | None, cert_pvc: str | None, cert_fra: str | None
) -> CatAnagraficaMatch:
