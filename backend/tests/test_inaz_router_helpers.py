...
from app.modules.inaz import router
from app.modules.inaz.schemas import InazBankHoursCompensationSummaryResponse
...
def test_build_bank_hours_liquidation_guidance_covers_no_balance_and_no_overtime_cases() -> None:
    ...
    summary = InazBankHoursCompensationSummaryResponse(overtime_day_minutes_total=120)
...
def test_build_bank_hours_liquidation_guidance_covers_missing_profile_threshold_and_partial_keep() -> None:
    ...
    summary = InazBankHoursCompensationSummaryResponse(
