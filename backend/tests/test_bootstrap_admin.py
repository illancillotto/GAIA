...
def test_ensure_bootstrap_admin_creates_admin_once(monkeypatch) -> None:
    ...
    assert first_user.enabled_modules == ["accessi", "rete", "inventario", "catasto", "utenze", "operazioni", "riordino", "ruolo", "inaz", "organigramma"]
...
def test_ensure_bootstrap_admin_updates_existing_admin(monkeypatch) -> None:
    ...
    assert user.enabled_modules == ["accessi", "rete", "inventario", "catasto", "utenze", "operazioni", "riordino", "ruolo", "inaz", "organigramma"]
